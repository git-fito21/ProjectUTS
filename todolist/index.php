<?php
    ...
    $q_insert = "insert into todolist (tasklabel, taskstatus) value (
        '".$_POST['task']."',
        'open'
    )";
    ...
    //proses show data
    $q_select = "select * from todolist order by taskid desc";
    $run_q_select = mysqli_query($conn, $q_select);

    //proses delete
    if(isset($_GET['delete'])){

        $q_delete = "delete from todolist where taskid = '".$_GET['delete']."' ";
    ...
    if(isset($_GET['done'])){
        ...
        $q_update = "update todolist set taskstatus = '".$status."' where taskid = '".$_GET['done']."' ";
